...
},{}],"../src/allCountries.js":[function(require,module,exports) {
"use strict";
...
var _default = allCountries.map(function (_ref) {
...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/ms/index.js":[function(require,module,exports) {
/**
 * Helpers.
 */
...
},{}],"../node_modules/jsonp/node_modules/debug/src/common.js":[function(require,module,exports) {
...
},{"ms":"../node_modules/ms/index.js"}],"../node_modules/jsonp/node_modules/debug/src/browser.js":[function(require,module,exports) {
var process = require("process");
/* eslint-env browser */
...
},{"./common":"../node_modules/jsonp/node_modules/debug/src/common.js","process":"../node_modules/process/browser.js"}],"../node_modules/jsonp/index.js":[function(require,module,exports) {
/**
 * Module dependencies
 */
...
},{"debug":"../node_modules/jsonp/node_modules/debug/src/browser.js"}],"../node_modules/get-json/lib/browser.js":[function(require,module,exports) {
module.exports = require('jsonp');

},{"jsonp":"../node_modules/jsonp/index.js"}],"../node_modules/get-json/index.js":[function(require,module,exports) {
var isNode = require('is-node');
var nodeRequire = require;

module.exports = isNode ? nodeRequire('./lib/node') : require('./lib/browser');

},{"is-node":"../node_modules/is-node/index.js","./lib/browser":"../node_modules/get-json/lib/browser.js"}],"../src/defaultCountry.js":[function(require,module,exports) {
"use strict";
...
var _getJson = _interopRequireDefault(require("get-json"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var getCountry = function getCountry() {
  return new Promise(function (resolve, reject) {
    (0, _getJson.default)('https://ipinfo.io/json', function (error, response) {
      if (error) {
        reject(error);
      }
...
var _default = getCountry;
exports.default = _default;
},{"get-json":"../node_modules/get-json/index.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../src/assets/sprite.css":[function(require,module,exports) {
...
},{}],"../src/VueCountryCode.vue":[function(require,module,exports) {
"use strict";
...
var _defaultCountry = _interopRequireDefault(require("./defaultCountry"));
  ...
  methods: {
    initializeCountry: function initializeCountry() {
      ...
      if (!this.disabledFetchingCountry) {
        (0, _defaultCountry.default)().then(function (res) {
    ...
    findCountry: function findCountry() {
      ...
      return _allCountries.default.find(function (country) {
...
exports.default = _default;
        var $4002f1 = exports.default || module.exports;
      
      if (typeof $4002f1 === 'function') {
        $4002f1 = $4002f1.options;
      }
    
        /* template */
        Object.assign($4002f1, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    { staticClass: "vue-country-select", class: { disabled: _vm.disabled } },
    [
      _c(
        "div",
        {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4002f1', $4002f1);
          } else {
            api.reload('$4002f1', $4002f1);
          }
        }
...
},{"./allCountries":"../src/allCountries.js","./defaultCountry":"../src/defaultCountry.js","./assets/sprite.css":"../src/assets/sprite.css","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../src/index.js":[function(require,module,exports) {
"use strict";
...
var _VueCountryCode = _interopRequireDefault(require("./VueCountryCode.vue"));
...
var _default = _objectSpread({}, _VueCountryCode.default, {
  install: function install(Vue) {
    Vue.component(_VueCountryCode.default.name, _VueCountryCode.default);
    return Vue;
  }
});

exports.default = _default;
},{"./VueCountryCode.vue":"../src/VueCountryCode.vue"}],"App.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $6c6c59 = exports.default || module.exports;
      
      if (typeof $6c6c59 === 'function') {
        $6c6c59 = $6c6c59.options;
      }
    
        /* template */
        Object.assign($6c6c59, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "app" } }, [
    _c("h1", [_vm._v("Telephone Country Select")]),
    _vm._v(" "),
    _c("h2", { staticStyle: { color: "#999" } }, [
      _vm._v("made with ❤ by Mon.")
    ]),
    _vm._v(" "),
    _c(
      "div",
    ...
    _vm._v(" "),
    _c("div", [_c("code", [_vm._v(_vm._s(_vm.selectedCountry))])])
  ])
}
var staticRenderFns = []
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6c6c59', $6c6c59);
          } else {
            api.reload('$6c6c59', $6c6c59);
          }
        }
...
new _vue.default(_objectSpread({}, _App.default)).$mount("#app");
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","../src/index":"../src/index.js","./App.vue":"App.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
